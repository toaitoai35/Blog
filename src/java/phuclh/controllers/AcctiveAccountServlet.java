...
public class AcctiveAccountServlet extends HttpServlet {
    ...
    private static final String ERROR = "activePage.jsp";
    /**
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String code = request.getParameter("txtCodeActive");
            ...
            if (code.equals(checkCode)) {
                ...
                boolean checkUpdate = dao.updateAccountStatus(dto);
                if (checkUpdate) {
                    dto = dao.getUserAccount(dto);
                    session.setAttribute("LOGIN_INFO", dto);
                    url = SUCCESS;
                }
            } else {
                request.setAttribute("MESSAGE", "Code active is wrong. Please check again");
            }
        } catch (Exception e) {
            e.printStackTrace();
        } finally {
