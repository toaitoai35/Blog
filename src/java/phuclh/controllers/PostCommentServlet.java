...
public class PostCommentServlet extends HttpServlet {
    ...
    private static final String SUCCESS = "LoadCommentServlet";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            CommentDTO commentDTO = new CommentDTO(Integer.parseInt(id), comment, currentDate, true, userDTO.getEmail());
